...
?>
<?$APPLICATION->IncludeComponent("bit-ecommerce:banners", ".default", array(
	"COMPONENT_TEMPLATE" => ".default",
		"IBLOCK_ID" => $arParams["IBLOCK_BANERS_ID"],
		"IBLOCK_ITEMS_COUNT" => "",
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "36000000",
		"CATALOG" => "Y"
	...
	$intSectionID = 0;
if ($_GET['sort'] == "") {$_GET['sort'] = "NAME"; $_GET['order'] = "asc";}
if ($_GET['sort'] == "PRICE") $_GET['sort'] = "catalog_PRICE_4"; // TODO ИД цены сделать динамически
	?>
	<?$intSectionID = $APPLICATION->IncludeComponent(
		...
		array(
			...
			"ELEMENT_SORT_ORDER" => $_GET['order'], //$arParams["ELEMENT_SORT_ORDER"],
